...
if __name__ == "__main__":
    ...
    target_joint_deg5 = [162.89, -85.22, -76.67, -20.78, 79.80, -65.78]
...
def multi_move():
    # 起始回位
    target_joint1 = [{target_joint_rad[0]}, {target_joint_rad[1]}, {target_joint_rad[2]}, {target_joint_rad[3]}, {target_joint_rad[4]}, {target_joint_rad[5]}]
    movej(target_joint1, a=1.0, v=0.5)
    sleep(6.0)

    target_joint2 = [{target_joint_rad2[0]}, {target_joint_rad2[1]}, {target_joint_rad2[2]}, {target_joint_rad2[3]}, {target_joint_rad2[4]}, {target_joint_rad2[5]}]
    movej(target_joint2, a=1.0, v=0.5)
    sleep(1.0)

    target_joint3 = [{target_joint_rad3[0]}, {target_joint_rad3[1]}, {target_joint_rad3[2]}, {target_joint_rad3[3]}, {target_joint_rad3[4]}, {target_joint_rad3[5]}]
    movej(target_joint3, a=1.0, v=0.5)
    sleep(1.0)
    ...
    target_joint5 = [{target_joint_rad5[0]}, {target_joint_rad5[1]}, {target_joint_rad5[2]}, {target_joint_rad5[3]}, {target_joint_rad5[4]}, {target_joint_rad5[5]}]
    movej(target_joint5, a=1.0, v=0.5)
    sleep(1.0)
